...
public class main {
    public static void main(String[] args) {
        ...
        System.out.println("¿Puede John redimir laboleta gratis?:");

        System.out.println(to2.redimirBeneficio(0));
        System.out.println("¿Puede John redimir lascrispetas gratis?:");

        System.out.println(to2.redimirBeneficio(1));
        System.out.println("¿Puede John redimir lagaseosa gratis?:");
